...
class LessonView extends StatefulWidget {
  ...
  static const String screen = "/lesson";

  LessonView({Key? key, required this.viewModel}) : super(key: key);
...
class SubLessonListTile extends StatelessWidget {
  ...
  SubLessonListTile({required this.sublesson, required this.onTap});
